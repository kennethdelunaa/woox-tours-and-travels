...
<?php 
  ...
  if(isset($_GET['id'])){
    ...
    cities.name AS name, 
    cities.img AS image, 
    cities.trip_days AS trip_days, 
    cities.price AS price, 
    COUNT(bookings.city_id) AS count_bookings
    FROM cities LEFT JOIN bookings ON cities.id = bookings.city_id WHERE cities.country_id = '$id' GROUP BY (bookings.city_id)");
    ...
    //numbers of booking for every country
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="info-item">
                <div class="row">
                  <div class="col-lg-6">
                    <h4><?php echo $num_of_cities->num_city; ?></h4>
